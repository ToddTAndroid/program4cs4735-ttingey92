...
public class Floor {
    ...
    public Floor(float xsize, float zsize) {

        FLOOR_COORDS = new float[]{   //Remember  x,z is the plane, y is up/down!
                xsize, 0, 0,   //top right  first triangle
                0, 0, 0,       //top left
                0, 0, zsize, //bottom left
                xsize, 0, 0, //top right second triangle
                0, 0, zsize, //bottom left
                xsize, 0, zsize,  //bottom right  umm, last comma isn't need I think...  not my orignal code.
        };
